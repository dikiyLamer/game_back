...
var Token = function () {
    ...
    var Token = _classThis = /** @class */ (function () {
        function Token_1() {
            ...
            this.user_id = (__runInitializers(this, _token_extraInitializers), __runInitializers(this, _user_id_initializers, void 0));
    ...
    (function () {
        ...
        _user_id_decorators = [(0, typeorm_1.PrimaryColumn)()];
